...
export function PageHero({
  ...
  return (
    <section className="relative bg-hero text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-32 pb-16 md:pt-36 md:pb-20 xl:pt-48 xl:pb-28">
        {eyebrow && (
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold leading-[1.1] md:leading-[1.05] max-w-4xl animate-fade-up">
          {title}
        </h1>
        {subtitle && (
